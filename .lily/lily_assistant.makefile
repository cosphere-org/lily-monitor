...
#
.PHONY: lint
lint:  ## lint the lily_monitor & tests
	...
	flake8 --ignore D100,D101,D102,D103,D104,D105,D106,D107,D202,D204,W504,W606 lily_monitor
...
lily_assistant_test:
	...
	source env.sh && \
	py.test --cov=lily_monitor --cov-fail-under=${TEST_COVERAGE_THRESHOLD} -r w -s -vv $(tests)
